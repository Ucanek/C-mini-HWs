...
/*
 * Minihomework 06: Malloc int pointer array
 * ---------------
 * Author: Lukas Rucka
 ...
 * ----------------------------------------------------------------------------
 *
 * 1. Complete following function such that it allocates array of n
 *    pointers to int values.
 * 2. Pre-initialize all pointers with NULL.
 */
